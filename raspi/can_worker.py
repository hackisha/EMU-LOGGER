...
from .config import CAN_CHANNEL, CAN_BITRATE, EMU_ID_BASE

# ======== EMU 파서 함수들 (emuLogger.py와 동일) ========
...
class CanWorker:
    ...
    def __init__(
        ...
        on_message: Optional[Callable[[int, Dict[str, Any]], None]] = None,
    ):
